...
const schema = [
  ...
  `CREATE TABLE IF NOT EXISTS agreements (id TEXT PRIMARY KEY, number TEXT NOT NULL UNIQUE, supplier_id TEXT NOT NULL REFERENCES suppliers(id), status TEXT NOT NULL DEFAULT 'draft', start_date TEXT NOT NULL, end_date TEXT, owner_user_id TEXT REFERENCES users(id), notes TEXT, provisional INTEGER NOT NULL DEFAULT 0, current_version_id TEXT, created_at TEXT NOT NULL, updated_at TEXT NOT NULL)`,

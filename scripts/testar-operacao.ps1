...
$cfg=@{ALERTAS_HORARIOS='08:00,12:00,17:00';BACKUP_HORARIOS='12:30,17:45';LIMPEZA_HORARIO='05:30'}
...
$estado=@{};$slot=Obter-SlotDevido 'alertas' $cfg.ALERTAS_HORARIOS $estado ([datetime]'2026-09-11 11:50');Igual '08:00' $slot.hora 'retorno antes das 12h'
$estado=@{};$slot=Obter-SlotDevido 'alertas' $cfg.ALERTAS_HORARIOS $estado ([datetime]'2026-09-11 18:30');Igual '17:00' $slot.hora 'retorno apos tres slots';Igual 2 (($estado.Keys|Where-Object{$_-like'alertas-*'}).Count) 'slots antigos marcados';$estado[$slot.chave]='ok';Igual $null (Obter-SlotDevido 'alertas' $cfg.ALERTAS_HORARIOS $estado ([datetime]'2026-09-11 18:31')) 'reinicio sem duplicidade'
$estado=@{'alertas-2026-09-11-08:00'='ok';'alertas-2026-09-11-12:00'='ok';'alertas-2026-09-11-17:00'='em-andamento'};Igual $null (Obter-SlotDevido 'alertas' $cfg.ALERTAS_HORARIOS $estado ([datetime]'2026-09-11 23:59')) 'execucao longa';$slot=Obter-SlotDevido 'alertas' $cfg.ALERTAS_HORARIOS $estado ([datetime]'2026-09-12 08:01');Igual '08:00' $slot.hora 'novo dia'
# --- Agenda por dia da semana -------------------------------------------
# Set 2026: 14=segunda, 17=quinta, 18=sexta, 19=sabado, 20=domingo.
$sem=@{ALERTAS_HORARIOS='08:00,12:00,17:00';ALERTAS_HORARIOS_SEX='08:00,12:00,16:00';ALERTAS_HORARIOS_SAB='';ALERTAS_HORARIOS_DOM='';BACKUP_HORARIOS='12:30,17:45';LIMPEZA_HORARIO='05:30'}
Validar-Horarios $sem
Igual '08:00,12:00,17:00' (Obter-HorariosDoDia $sem 'ALERTAS_HORARIOS' ([datetime]'2026-09-14 09:00')) 'segunda usa o padrao'
Igual '08:00,12:00,17:00' (Obter-HorariosDoDia $sem 'ALERTAS_HORARIOS' ([datetime]'2026-09-17 09:00')) 'quinta usa o padrao'
Igual '08:00,12:00,16:00' (Obter-HorariosDoDia $sem 'ALERTAS_HORARIOS' ([datetime]'2026-09-18 09:00')) 'sexta tem agenda propria'
...
foreach($dia in @('2026-09-19','2026-09-20')){
  foreach($hora in @('07:59','08:00','12:00','16:00','17:00','23:59')){
...
# Sexta as 16:30 ja cumpriu o ultimo slot; as 17:00 nada mais e devido.
$estado=@{};$slot=Obter-SlotDevido 'alertas' (Obter-HorariosDoDia $sem 'ALERTAS_HORARIOS' ([datetime]'2026-09-18 16:30')) $estado ([datetime]'2026-09-18 16:30')
Igual '16:00' $slot.hora 'sexta encerra as 16:00';$estado[$slot.chave]='ok'
...
try{Validar-Horarios @{ALERTAS_HORARIOS='08:00';ALERTAS_HORARIOS_SEX='16:0';BACKUP_HORARIOS='12:30';LIMPEZA_HORARIO='05:30'};throw 'Horario de dia invalido foi aceito'}catch{if($_.Exception.Message-eq'Horario de dia invalido foi aceito'){throw}}
